...
#else
	#define INL FORCEINLINE // to prevent tons of small functions in debug mode
	#define VEC_STATIC static
#endif
...
fv2::operator u8v2() const {	return u8v2((u8)x, (u8)y); }
fv3::operator u8v3() const {	return u8v3((u8)x, (u8)y, (u8)z); }
fv4::operator u8v4() const {	return u8v4((u8)x, (u8)y, (u8)z, (u8)w); }

fv2::operator s32v2() const {	return s32v2((s32)x, (s32)y); }
fv3::operator s32v3() const {	return s32v3((s32)x, (s32)y, (s32)z); }
fv4::operator s32v4() const {	return s32v4((s32)x, (s32)y, (s32)z, (s32)w); }
